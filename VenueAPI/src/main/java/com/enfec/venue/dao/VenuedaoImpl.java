...
import com.enfec.venue.model.VenueRowMapper;
...
public class VenuedaoImpl implements Venuedao {
	...
	public int deleteVenue(int venue_id) {
		...
		affectedRow = jdbcTemplate.update(sql1, venue_id);
		affectedRow = jdbcTemplate.update(sql2, venue_id);
