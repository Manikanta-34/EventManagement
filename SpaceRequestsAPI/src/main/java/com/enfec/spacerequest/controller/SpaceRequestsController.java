package com.enfec.spacerequest.controller;
...
import com.enfec.spacerequest.dao.SpaceRequestsdao;
...
public class SpaceRequestsController {
	...
	/*
	 * Getting the details of SpaceRequests based on space_Request_id
	 * 
	 * @param space_Request_id
	 * 
	 * @return ResponseEntity message.
	 */
